...
public class HitObject implements Cloneable {
	...
	public String toString() {
		if (type == 1) {
			// for a single note
			return "" + xposition + "," + ypos + "," + startTime + "," + 1 + "," + whistle_finish_clap.getValue() + ","
					+ sampleSet.getValue() + ":" + addition.getValue() + ":0:" + volume + ":" + hitSound;
		}
		// for a LN
		return "" + xposition + "," + ypos + "," + startTime + "," + 128 + "," + whistle_finish_clap.getValue() + ","
	...
	public void applyTimingPoint(ArrayList<Timing> timingPoints) {
		long t = startTime;
